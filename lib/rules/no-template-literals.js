 ...
 * @param  {TemplateLiteral} node TemplateLiteral node.(not within TaggedTemplateExpression)
...
module.exports = createRule({
    meta: {
        docs: {
            ...
            category: "ES2015",
            recommended: false,
            url: "https://eslint-community.github.io/eslint-plugin-es-x/rules/no-template-literals.html",
        },
        fixable: "code",
        messages: {
