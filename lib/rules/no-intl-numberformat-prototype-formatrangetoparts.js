...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: false,
            url: "https://eslint-community.github.io/eslint-plugin-es-x/rules/no-intl-numberformat-prototype-formatrangetoparts.html",
        },
        fixable: null,
        messages: {
    ...
    create(context) {
        return definePrototypePropertiesHandler(context, {
            "Intl.NumberFormat": { formatRangeToParts: "function" },
        })
    },
}
