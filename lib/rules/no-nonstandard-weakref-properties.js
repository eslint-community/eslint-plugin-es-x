...
const { weakRefProperties } = require("../util/well-known-properties")
...
module.exports = {
    meta: {
        docs: {
            ...
            recommended: false,
            url: "https://eslint-community.github.io/eslint-plugin-es-x/rules/no-nonstandard-weakref-properties.html",
        },
        fixable: null,
        messages: {
