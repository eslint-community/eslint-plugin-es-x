...
import { disposableStackPrototypeProperties } from "../util/well-known-properties.ts"
...
export default createRule<"forbidden", Options>({
    meta: {
        docs: {
            ...
            recommended: false,
            url: "https://eslint-community.github.io/eslint-plugin-es-x/rules/no-nonstandard-disposablestack-prototype-properties.html",
        },
        fixable: null,
        messages: {
