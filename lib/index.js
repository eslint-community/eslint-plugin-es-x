    ...
    configs: {
        flat: {
            get "no-new-in-es5"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es5"),
                }
            },
            get "no-new-in-es2015"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2015"),
                }
            },
            get "no-new-in-es2015-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2015-intl-api"),
                }
            },
            get "no-new-in-es2016"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2016"),
                }
            },
            get "no-new-in-es2016-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2016-intl-api"),
                }
            },
            get "no-new-in-es2017"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2017"),
                }
            },
            get "no-new-in-es2017-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2017-intl-api"),
                }
            },
            get "no-new-in-es2018"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2018"),
                }
            },
            get "no-new-in-es2018-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2018-intl-api"),
                }
            },
            get "no-new-in-es2019"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2019"),
                }
            },
            get "no-new-in-es2019-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2019-intl-api"),
                }
            },
            get "no-new-in-es2020"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2020"),
                }
            },
            get "no-new-in-es2020-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2020-intl-api"),
                }
            },
            get "no-new-in-es2021"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2021"),
                }
            },
            get "no-new-in-es2021-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2021-intl-api"),
                }
            },
            get "no-new-in-es2022"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2022"),
                }
            },
            get "no-new-in-es2022-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2022-intl-api"),
                }
            },
            get "no-new-in-es2023"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2023"),
                }
            },
            get "no-new-in-es2023-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-es2023-intl-api"),
                }
            },
            get "no-new-in-esnext"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-esnext"),
                }
            },
            get "no-new-in-esnext-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/no-new-in-esnext-intl-api"),
                }
            },
            get "restrict-to-es-intl-api-1st-edition"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es-intl-api-1st-edition"),
                }
            },
            get "restrict-to-es3"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es3"),
                }
            },
            get "restrict-to-es5"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es5"),
                }
            },
            get "restrict-to-es2015"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2015"),
                }
            },
            get "restrict-to-es2015-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2015-intl-api"),
                }
            },
            get "restrict-to-es2016"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2016"),
                }
            },
            get "restrict-to-es2016-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2016-intl-api"),
                }
            },
            get "restrict-to-es2017"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2017"),
                }
            },
            get "restrict-to-es2017-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2017-intl-api"),
                }
            },
            get "restrict-to-es2018"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2018"),
                }
            },
            get "restrict-to-es2018-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2018-intl-api"),
                }
            },
            get "restrict-to-es2019"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2019"),
                }
            },
            get "restrict-to-es2019-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2019-intl-api"),
                }
            },
            get "restrict-to-es2020"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2020"),
                }
            },
            get "restrict-to-es2020-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2020-intl-api"),
                }
            },
            get "restrict-to-es2021"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2021"),
                }
            },
            get "restrict-to-es2021-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2021-intl-api"),
                }
            },
            get "restrict-to-es2022"() {
                return {
                    plugins: { "es-x": plugin },
                    ...require("./configs/restrict-to-es2022"),
                }
            },
            get "restrict-to-es2022-intl-api"() {
                return {
                    plugins: { "es-x": plugin },
