...
module.exports = {
    ...
    rules: {
        ...
        "no-aggregate-error": require("./rules/no-aggregate-error"),
        ...
        "no-finalization-registry": require("./rules/no-finalization-registry"),
        ...
        "no-weak-ref": require("./rules/no-weak-ref"),
