...
const plugin = {
    meta: { version, name },
    configs: {
        get "flat/no-new-in-es5"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es5"),
            }
        },
        get "flat/no-new-in-es2015"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2015"),
            }
        },
        get "flat/no-new-in-es2015-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2015-intl-api"),
            }
        },
        get "flat/no-new-in-es2016"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2016"),
            }
        },
        get "flat/no-new-in-es2016-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2016-intl-api"),
            }
        },
        get "flat/no-new-in-es2017"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2017"),
            }
        },
        get "flat/no-new-in-es2017-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2017-intl-api"),
            }
        },
        get "flat/no-new-in-es2018"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2018"),
            }
        },
        get "flat/no-new-in-es2018-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2018-intl-api"),
            }
        },
        get "flat/no-new-in-es2019"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2019"),
            }
        },
        get "flat/no-new-in-es2019-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2019-intl-api"),
            }
        },
        get "flat/no-new-in-es2020"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2020"),
            }
        },
        get "flat/no-new-in-es2020-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2020-intl-api"),
            }
        },
        get "flat/no-new-in-es2021"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2021"),
            }
        },
        get "flat/no-new-in-es2021-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2021-intl-api"),
            }
        },
        get "flat/no-new-in-es2022"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2022"),
            }
        },
        get "flat/no-new-in-es2022-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2022-intl-api"),
            }
        },
        get "flat/no-new-in-es2023"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2023"),
            }
        },
        get "flat/no-new-in-es2023-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-es2023-intl-api"),
            }
        },
        get "flat/no-new-in-esnext"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-esnext"),
            }
        },
        get "flat/no-new-in-esnext-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/no-new-in-esnext-intl-api"),
            }
        },
        get "flat/restrict-to-es-intl-api-1st-edition"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es-intl-api-1st-edition"),
            }
        },
        get "flat/restrict-to-es3"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es3"),
            }
        },
        get "flat/restrict-to-es5"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es5"),
            }
        },
        get "flat/restrict-to-es2015"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2015"),
            }
        },
        get "flat/restrict-to-es2015-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2015-intl-api"),
            }
        },
        get "flat/restrict-to-es2016"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2016"),
            }
        },
        get "flat/restrict-to-es2016-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2016-intl-api"),
            }
        },
        get "flat/restrict-to-es2017"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2017"),
            }
        },
        get "flat/restrict-to-es2017-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2017-intl-api"),
            }
        },
        get "flat/restrict-to-es2018"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2018"),
            }
        },
        get "flat/restrict-to-es2018-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2018-intl-api"),
            }
        },
        get "flat/restrict-to-es2019"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2019"),
            }
        },
        get "flat/restrict-to-es2019-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2019-intl-api"),
            }
        },
        get "flat/restrict-to-es2020"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2020"),
            }
        },
        get "flat/restrict-to-es2020-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2020-intl-api"),
            }
        },
        get "flat/restrict-to-es2021"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2021"),
            }
        },
        get "flat/restrict-to-es2021-intl-api"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2021-intl-api"),
            }
        },
        get "flat/restrict-to-es2022"() {
            return {
                plugins: { "es-x": plugin },
                ...require("./configs/flat/restrict-to-es2022"),
            }
        },
        get "flat/restrict-to-es2022-intl-api"() {
            return {
                plugins: { "es-x": plugin },
