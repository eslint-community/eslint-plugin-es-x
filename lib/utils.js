...
module.exports = {
    ...
    *getRegExpCalls(globalScope) {
    ...
    printWarningOfDeprecatedConfig(configId) {
        // typeof will always work, while other checks may throw ReferenceError.
     ...
     * @param {PropertyDefinition|MethodDefinition} node - The node to get.
     * @param {SourceCode} sourceCode The source code object to get the code of computed property keys.
     * @returns {string} The name of the node.
     */
    getFieldName(node, sourceCode) {
