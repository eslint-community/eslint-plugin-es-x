...
class DataSet {
    private readonly _raw2018: string

    private readonly _raw2019: string

    private readonly _raw2020: string

    private readonly _raw2021: string

    private readonly _raw2022: string

    private readonly _raw2023: string

    private readonly _raw2024: string

    private readonly _raw2025: string

    private readonly _raw2026: string
    ...
    private _set2024: Set<string> | undefined

    private _set2025: Set<string> | undefined

    private _set2026: Set<string> | undefined
...
export const gcValueSets = new DataSet(
...
export const scValueSets = new DataSet(
    ...
    "Berf Beria_Erfe Gara Garay Gukh Gurung_Khema Hrkt Jurc Jurchen Katakana_Or_Hiragana Kawi Kirat_Rai Krai Nag_Mundari Nagm Ol_Onal Onao Pcun Proto_Cuneiform Seal Sidetic Sidt Sunu Sunuwar Tai_Yo Tayo Todhri Todr Tolong_Siki Tols Tulu_Tigalari Tutg Unknown Zzzz",
    "",
    "",
    "",
)
export const binPropertySets = new DataSet(
