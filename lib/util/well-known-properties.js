...
const temporalProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-constructor-properties-of-the-temporal-object
    "Duration",
    "Instant",
    "PlainDate",
    "PlainDateTime",
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-other-properties-of-the-temporal-object
    "Now",
])
...
const temporalInstantProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-instant-constructor
    "prototype",
    "from",
...
const temporalZonedDateTimeProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-zoneddatetime-constructor
    "prototype",
    "from",
    "compare",
])
...
const temporalPlainDateTimeProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-plaindatetime-constructor
    "prototype",
    "from",
    "compare",
])
...
const temporalPlainDateProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-plaindate-constructor
    "prototype",
    "from",
    "compare",
])
...
const temporalPlainTimeProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-plaintime-constructor
    "prototype",
    "from",
    "compare",
])
...
const temporalPlainYearMonthProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-plainyearmonth-constructor
    "prototype",
    "from",
    "compare",
])
...
const temporalPlainMonthDayProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-plainmonthday-constructor
    "prototype",
    "from",
])
...
const temporalDurationProperties = new Set([
    ...
    // https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-properties-of-the-temporal-duration-constructor
    "prototype",
    "from",
    "compare",
])
