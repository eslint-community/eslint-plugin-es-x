...
const WELLKNOWN_GLOBALS = {
    ...
    DisposableStack: {
        ...
        /** @type {Record<import('./types').DisposableStackProperty,TypeInfo|undefined>} */
        properties: {},
    },
    AsyncDisposableStack: {
        ...
        /** @type {Record<import('./types').AsyncDisposableStackProperty,TypeInfo|undefined>} */
        properties: {},
    },
    WeakRef: {
        type: "Function",
    ...
    Math: {
        type: "Object",
        /** @type {Record<import('./types').MathProperty,TypeInfo|undefined>} */
        properties: {
...
const WELLKNOWN_PROTOTYPE = /** @type {WellKnownPrototypes} */ ({
    ...
    /** @type {Record<import('./types').DisposableStackPrototypeProperty, TypeInfo>} */
    DisposableStack: {
        adopt: { type: "Function" },
    ...
    /** @type {Record<import('./types').AsyncDisposableStackPrototypeProperty, TypeInfo>} */
    AsyncDisposableStack: {
 ...
 * @template {string} K
 * @param {TypeName} type
 * @param {Partial<Record<K, TypeInfo>>} [otherProperties]
 * @returns {TypeInfo}
 */
function buildGlobalTypedArrayTypeInfo(type, otherProperties = {}) {
    return {
        ...
        return: { type },
        prototypeType: type,
        /** @type {Record<import('./types').TypedArrayProperty | K,TypeInfo|undefined>} */
        properties: {
...
/**
 * @template {string} K = never
 * @param {TypeName} type
 * @param {Partial<Record<K, TypeInfo>>} otherProperties
 * @returns {Record<import('./types').TypedArrayPrototypeProperty, TypeInfo> & Partial<Record<K, TypeInfo>>}
 */
