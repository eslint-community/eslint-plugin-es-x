...
import rule from "../../../lib/rules/no-nonstandard-temporal-plaindate-prototype-properties.ts"
import { temporalPlainDatePrototypeProperties } from "../../../lib/util/well-known-properties.ts"
