...
const rule = require("../../../lib/rules/no-nonstandard-temporal-plaintime-prototype-properties.js")
const {
...
new RuleTester({
    ...
    "no-nonstandard-temporal-plaintime-prototype-properties TS Full Type Information",
    rule,
    {
        valid: [
            { filename, code: "foo" },
