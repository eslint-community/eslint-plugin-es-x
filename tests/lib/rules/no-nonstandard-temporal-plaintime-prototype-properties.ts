...
import rule from "../../../lib/rules/no-nonstandard-temporal-plaintime-prototype-properties.ts"
import { temporalPlainTimePrototypeProperties } from "../../../lib/util/well-known-properties.ts"
