...
import rule from "../../../lib/rules/no-nonstandard-asyncdisposablestack-prototype-properties.ts"
import { asyncDisposableStackPrototypeProperties } from "../../../lib/util/well-known-properties.ts"
