...
import rule from "../../../lib/rules/no-nonstandard-temporal-zoneddatetime-prototype-properties.ts"
import { temporalZonedDateTimePrototypeProperties } from "../../../lib/util/well-known-properties.ts"
