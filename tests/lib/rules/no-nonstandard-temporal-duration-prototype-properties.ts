...
import rule from "../../../lib/rules/no-nonstandard-temporal-duration-prototype-properties.ts"
import { temporalDurationPrototypeProperties } from "../../../lib/util/well-known-properties.ts"
