...
import rule from "../../../lib/rules/no-nonstandard-temporal-plainmonthday-prototype-properties.ts"
import { temporalPlainMonthDayPrototypeProperties } from "../../../lib/util/well-known-properties.ts"
