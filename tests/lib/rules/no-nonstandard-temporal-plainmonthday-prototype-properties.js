...
const rule = require("../../../lib/rules/no-nonstandard-temporal-plainmonthday-prototype-properties.js")
const {
...
new RuleTester({
    ...
    "no-nonstandard-temporal-plainmonthday-prototype-properties TS Full Type Information",
    rule,
    {
        valid: [
            { filename, code: "foo" },
