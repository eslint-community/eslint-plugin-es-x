...
const rule = require("../../../lib/rules/no-nonstandard-temporal-zoneddatetime-prototype-properties.js")
const {
...
new RuleTester({
    ...
    "no-nonstandard-temporal-zoneddatetime-prototype-properties TS Full Type Information",
    rule,
    {
        valid: [
            { filename, code: "foo" },
