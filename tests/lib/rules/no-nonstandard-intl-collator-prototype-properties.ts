...
import rule from "../../../lib/rules/no-nonstandard-intl-collator-prototype-properties.ts"
import { intlCollatorPrototypeProperties } from "../../../lib/util/well-known-properties.ts"
