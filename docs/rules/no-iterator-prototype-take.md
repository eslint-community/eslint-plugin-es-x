...
This rule reports ES2025 [`Iterator.prototype.take` method](https://github.com/tc39/proposal-iterator-helpers) as errors.
...
```js
/*eslint es-x/no-iterator-prototype-take: [error, { aggressive: true }] */
Iterator.from([]).take(3)
```
