...
This rule reports ES2025 [`Iterator.prototype.drop` method](https://github.com/tc39/proposal-iterator-helpers) as errors.
...
```js
/*eslint es-x/no-iterator-prototype-drop: [error, { aggressive: true }] */
Iterator.from([]).drop(3)
```
