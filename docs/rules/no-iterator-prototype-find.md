...
This rule reports ES2025 [`Iterator.prototype.find` method](https://github.com/tc39/proposal-iterator-helpers) as errors.
...
```js
/*eslint es-x/no-iterator-prototype-find: [error, { aggressive: true }] */
Iterator.from([]).find(a => !!a)
```
