...
This rule reports ES2025 [`Iterator.prototype.toArray` method](https://github.com/tc39/proposal-iterator-helpers) as errors.
...
```js
/*eslint es-x/no-iterator-prototype-toarray: [error, { aggressive: true }] */
