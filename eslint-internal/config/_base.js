...
module.exports = [
    ...
    },
    {
        ...
        rules: {
            ...
            "my/my-block-scoped-var": "error",
            "my/my-no-instanceof-array": "error",
            "my/my-no-instanceof-wrapper": "error",
            "my/my-no-literal-call": "error",
            "my/my-no-this-in-static": "off",
            "my/my-no-use-ignored-vars": ["error", "^_(?:[^_].*)?$"],
            "my/my-no-useless-rest-spread": "off",
            "my/my-prefer-for-of": "off",
        },
    },
]
